...
- **Conditional, separate job:** `claude plugin eval`, only when a PR touches
  `plugins/**/skills/**`, `agents/**`, `hooks/**`, `evals/**`, `.claude-plugin/**`,
  `.lsp.json` or `.mcp.json` — and only for the plugins whose diff changed.
