...
- [ ] The plugin README follows the [README contract](../templates/plugin-README-reusable-template.md): all 15 sections present, and **What it does not do**, **Security**, and **Limitations** match this version.
