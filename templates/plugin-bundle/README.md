<!-- bundle shape of templates/plugin-README-reusable-template.md (the master). Replace every {{placeholder}}; keep every section; delete this comment. -->
...
| {{Add one row per agent, or write "None".}} | | | |
