...
| [Evidence Reader](plugins/evidence-reader/README.md) | When Claude reads your files, it reads all of them, cites where every fact came from, and tells you plainly what it could not read. | `bundle` | 🧪 | 🧪 | Python ≥ 3.14, Bash ≥ 3.2, `jq` ≥ 1.6; recommended: poppler, exiftool, ImageMagick |
| [Repo Hygiene](plugins/repo-hygiene/README.md) | Ask Claude to audit and clean a repository, and it inspects everything a senior Git expert would — then changes only what you approve. | `bundle` | 🧪 | ❌ | Git ≥ 2.38; optional: `gh` or `glab` |
