...
| [Evidence Reader](plugins/evidence-reader/README.md) | When Claude reads your files, it reads all of them, cites where every fact came from, and tells you plainly what it could not read. | `bundle` | 🧪 | 🧪 | Python ≥ 3.14, Bash ≥ 3.2, `jq` ≥ 1.6 |
