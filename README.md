...
| [Evidence Reader](plugins/evidence-reader/README.md) | Makes Claude read documents, spreadsheets, data files and images completely and report back with a receipt for every claim, instead of skimming or guessing. | `bundle` | 🧪 | 🧪 | Python ≥ 3.14, Bash ≥ 3.2, `jq` ≥ 1.6 |
